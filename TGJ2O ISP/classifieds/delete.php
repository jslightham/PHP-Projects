...
$sql = "DELETE FROM listings WHERE id = $adId AND username = '$user'";
...
<div class="image">
<center>
<h1>Are you sure you would like to delete your ad?</h1>
</center>

</div>
<div class="title">
  <form method="post" action="/classifieds/delete.php?id=<?php echo $adId; ?>">
  <hr />
<center>
<div class="details">
<center>
<input type="submit" name="submit" value="Yes" style="width: 80%; background-color: #263e4a; border: none; color: white; border-radius: 0px; padding: 8px;" /></center>
